...
func TestBuild(t *testing.T) {
	basicConfig := func() *PromtailInputConfig {
		...
		cfg.PromtailConfig = &PromtailConfig{
	...
	cases := []struct {
		name             string
		modifyBaseConfig func(config *PromtailInputConfig)
		errorRequirement require.ErrorAssertionFunc
		validate         func(*testing.T, *PromtailInput)
	}{
		{
			name:             "Basic",
			modifyBaseConfig: func(f *PromtailInputConfig) {},
		...
		},
		{
			...
			modifyBaseConfig: func(f *PromtailInputConfig) {
				f.PromtailConfig.ScrapeConfig = nil
			},
		...
		},
		{
			...
			modifyBaseConfig: func(f *PromtailInputConfig) {
				f.PromtailConfig.TargetConfig = file.Config{}
			},
			errorRequirement: require.Error,
			validate:         nil,
		},
